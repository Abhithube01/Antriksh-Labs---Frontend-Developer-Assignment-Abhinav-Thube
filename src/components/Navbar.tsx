  ...
  return (
    <nav className="sm:w-[550px] w-full flex items-center justify-between border-b border-solid border-[#ccc]">
      <Link
        ...
        className={`${
          todosFilter === null
            ? "border-pink-600 text-gray-800 font-semibold hover:border-pink-600"
            : ""
        } md:text-xl text-gray-500 border-solid border-b-4 border-transparent hover:border-blac-500`}
      >
        To Do
      </Link>
      <Link
